...
export default function PaymentMethods() {
  return (
    <section className="py-4 bg-secondary border-t border-border">
      <div className="container max-w-screen-xl mx-auto px-6 flex items-center justify-center gap-5">
        <span className="text-xs text-muted-foreground">
          Paiements sécurisés
        </span>
        <div className="flex gap-2">
          <div className="bg-card border border-border rounded-md px-3 py-1">
            <svg
          ...
          <div className="bg-card border border-border rounded-md px-3 py-1 flex items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-auto text-foreground/70"
              fill="none"
              viewBox="0 0 24 24"
              stroke="currentColor"
            >
