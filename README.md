...
5. Run migrations with following commands:
   ...
   ```bash
   npm run db:link supabase_project_id
   npm run db:up
   ```
...
- Ajouter un champs d'acception des CGVs + champs date d'accesption
- Case à cocher acception CGV sur le form de réservation
- Ajouter un champs numero de vol dans la réservation
